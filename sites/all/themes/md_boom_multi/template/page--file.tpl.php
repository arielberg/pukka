...
<div class="flx-wrapper">
    ...
    <?php if (theme_get_setting('home_mega_slider_1') && !empty($page['mega_slider_1'])):?>
        <?php print render($page['mega_slider_1']);?>
    <?php elseif (theme_get_setting('home_mega_slider_2') && !empty($page['mega_slider_2'])):?>
    ...
    <div class="wrapper">
        <div class="main-content clearfix">
            <?php endif;?>
            <div class="row-fluid">
                <?php if(strposa(current_path(),array('taxonomy','comment','user','search','file')) !== false){print '<div class="wrapper">';}?>
                <?php if ($tabs['#primary'] != null): ?><div class="tabs"><div class="wrapper"><?php print render($tabs); ?></div></div><?php endif; ?>
                ...
                <?php endif;?>
                <?php if(strposa(current_path(),array('taxonomy','comment','user','search','file')) !== false){print '</div>';}?>
            </div>
            <?php if($page['sidebar']):?>
        </div>
    </div>
