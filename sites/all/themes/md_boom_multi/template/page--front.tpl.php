...
<div class="flx-wrapper">
    <header id="flx-header" class="<?php if(theme_get_setting('header_style','md_boom_multi') == 'header2'){print t('head-s2');} elseif(theme_get_setting('header_style','md_boom_multi') == 'header3'){print t('head-s3');} elseif(theme_get_setting('header_style','md_boom_multi') == 'header4') {print t('head-s4');}?> clearfix">
    ...
    <?php if (theme_get_setting('front_page','md_boom_multi') == 'home_mega_slider_1' && !empty($page['mega_slider_1'])):?>
        <section class="mega-slider-1-wrapper">
            <?php if ($page['mega_slider_1']):?>
                <?php print render($page['mega_slider_1']);?>
            <?php endif;?>
        </section>
    <?php elseif (theme_get_setting('front_page','md_boom_multi') == 'home_mega_slider_2' && !empty($page['mega_slider_2'])):?>
        <section class="mega-slider-2-wrapper">
            <?php if ($page['mega_slider_2']):?>
                <?php print render($page['mega_slider_2']);?>
            <?php endif;?>
        </section>
    <?php else:?>
            ...
            <div class="wrapper">
                <div class="header-title-inner">
                    <div class="page-title">
                        <h3><?php if(isset($path_title)) { print $path_title;} else {print $title;}?></h3>
                        <h6><?php if(isset($path_description)) { print $path_description;}?></h6>
                    </div>
                </div>
            </div><!--end:wrapper-->
    ...
    <div class="wrapper">
        <div class="main-content clearfix">
            <?php endif;?>
            <div class="row-fluid">
                <?php if(strposa(current_path(),array('taxonomy','comment','user','search')) !== false){print '<div class="wrapper">';}?>
                ...
                <?php endif;?>
                <?php if(strposa(current_path(),array('taxonomy','comment','user','search')) !== false){print '</div>';}?>
            </div>
            <?php if($page['sidebar']):?>
        </div>
    </div>
