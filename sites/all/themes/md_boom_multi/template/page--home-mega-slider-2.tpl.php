...
<?php endif;?>
    ...
    <div class="wrapper">
        <div class="row-fluid">
            <?php if($page['content']):?>
                <?php if($page['sidebar'] && theme_get_setting('sidebar_position') != 'no'):?><div class="<?php print 'span9';?>"><?php endif;?>
                <?php print render($page['content']);?>
                <?php if($page['sidebar'] && theme_get_setting('sidebar_position') != 'no'):?></div><?php endif;?>
            <?php endif;?>
