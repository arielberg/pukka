...
?>
    <section class="logo-widget">
        <h2 class="view-<?php print $view_name?>-title widget-title"><?php if($display_title) { print $display_title;} else {print $view_human_name;}?></h2>
